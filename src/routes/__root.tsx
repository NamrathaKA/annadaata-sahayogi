...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FarmPido — Farmer-to-Buyer Marketplace" },
      { name: "description", content: "AI-powered Kannada-first marketplace connecting Indian farmers directly to buyers and delivery partners." },
      { name: "author", content: "FarmPido" },
      { property: "og:title", content: "FarmPido — Farmer-to-Buyer Marketplace" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&family=Noto+Sans+Kannada:wght@400;500;600;700&display=swap" },
    ],
  }),
