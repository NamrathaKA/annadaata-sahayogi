...
const kn: Dict = {
  ...
  schedule_intro: "ಪಿಕಪ್ ಸಮಯದ ಪ್ರಕಾರ ದಿನವಾರು ಪ್ರಯಾಣ ಯೋಜನೆ",
  today: "ಇಂದು",
  tomorrow: "ನಾಳೆ",
  unscheduled: "ಸಮಯ ನಿಗದಿ ಆಗಿಲ್ಲ",
  no_schedule: "ಇನ್ನೂ ಯಾವುದೇ ವೇಳಾಪಟ್ಟಿ ಇಲ್ಲ",
  total_earnings: "ಒಟ್ಟು ಶುಲ್ಕ",
...
const en: Dict = {
  ...
  schedule_intro: "Day-by-day trip plan sorted by pickup time",
  today: "Today",
  tomorrow: "Tomorrow",
  unscheduled: "Not scheduled yet",
  no_schedule: "No schedule yet",
  total_earnings: "Total fee",
...
const hi: Dict = {
  ...
  schedule_intro: "पिकअप समय के अनुसार दिनवार यात्रा योजना",
  today: "आज",
  tomorrow: "कल",
  unscheduled: "समय तय नहीं",
  no_schedule: "अभी कोई शेड्यूल नहीं",
  total_earnings: "कुल शुल्क",
